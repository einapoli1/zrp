...
func TestHandleCreateCAPAFromNCR_Success(t *testing.T) {
	...
	handleCreateCAPAFromNCR(w, req, "NCR-001")
...
func TestHandleCreateCAPAFromNCR_AutoPopulate(t *testing.T) {
	...
	handleCreateCAPAFromNCR(w, req, "NCR-002")
...
func TestHandleCreateCAPAFromNCR_EmptyBody(t *testing.T) {
	...
	handleCreateCAPAFromNCR(w, req, "NCR-003")
...
func TestHandleCreateCAPAFromNCR_NCRNotFound(t *testing.T) {
	...
	handleCreateCAPAFromNCR(w, req, "NCR-999")
...
func TestHandleCreateCAPAFromNCR_InvalidJSON(t *testing.T) {
	...
	handleCreateCAPAFromNCR(w, req, "NCR-004")
...
func TestHandleCreateECOFromNCR_Success(t *testing.T) {
	...
	handleCreateECOFromNCR(w, req, "NCR-001")
...
func TestHandleCreateECOFromNCR_AutoPopulate(t *testing.T) {
	...
	handleCreateECOFromNCR(w, req, "NCR-002")
...
func TestHandleCreateECOFromNCR_PriorityMapping(t *testing.T) {
	...
	for i, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			_, err := db.Exec(`INSERT INTO ncrs (id, title, severity, created_at) VALUES (?, 'Test NCR', ?, '2026-01-01 10:00:00')`,
				ncrID, tc.severity)
			if err != nil {
				t.Fatalf("Failed to insert test NCR: %v", err)
			}
...
func TestHandleCreateECOFromNCR_DescriptionFallback(t *testing.T) {
	...
	handleCreateECOFromNCR(w, req, "NCR-003")
...
func TestHandleCreateECOFromNCR_NCRNotFound(t *testing.T) {
	...
	handleCreateECOFromNCR(w, req, "NCR-999")
...
func TestHandleCreateECOFromNCR_InvalidJSON(t *testing.T) {
	...
	handleCreateECOFromNCR(w, req, "NCR-004")
...
func TestHandleCreateCAPAFromNCR_DataIntegrity(t *testing.T) {
	...
	handleCreateCAPAFromNCR(w, req, "NCR-005")
	...
	var dbCapa CAPA
	err = db.QueryRow(`SELECT id, title, type, linked_ncr_id, root_cause, action_plan, status 
...
func TestHandleCreateECOFromNCR_DataIntegrity(t *testing.T) {
	...
	handleCreateECOFromNCR(w, req, "NCR-006")
	...
	err = db.QueryRow(`SELECT id, title, status, priority, ncr_id, COALESCE(affected_ipns, '') 
...
func TestHandleCreateCAPAFromNCR_AuditLog(t *testing.T) {
	...
	handleCreateCAPAFromNCR(w, req, "NCR-007")
	...
	var count int
	db.QueryRow("SELECT COUNT(*) FROM audit_log WHERE module='capa' AND action='created'").Scan(&count)
...
func TestHandleCreateECOFromNCR_AuditLog(t *testing.T) {
	...
	handleCreateECOFromNCR(w, req, "NCR-008")
	...
	// Verify audit log entry was created
	var count int
	db.QueryRow("SELECT COUNT(*) FROM audit_log WHERE module='eco' AND action='created'").Scan(&count)
...
func TestHandleCreateCAPAFromNCR_ChangeTracking(t *testing.T) {
	...
	// Insert test NCR
	_, err := db.Exec(`INSERT INTO ncrs (id, title, severity, created_at) VALUES 
		('NCR-009', 'Change Tracking Test', 'minor', '2026-01-01 10:00:00')
	`)
	if err != nil {
		t.Fatalf("Failed to insert test NCR: %v", err)
	}

	req := httptest.NewRequest("POST", "/api/v1/ncrs/NCR-009/create-capa", nil)
	w := httptest.NewRecorder()

	handleCreateCAPAFromNCR(w, req, "NCR-009")
...
func TestHandleCreateECOFromNCR_ChangeTracking(t *testing.T) {
	...
	// Insert test NCR
	_, err := db.Exec(`INSERT INTO ncrs (id, title, severity, created_at) VALUES 
		('NCR-010', 'Change Tracking Test', 'minor', '2026-01-01 10:00:00')
	`)
	if err != nil {
		t.Fatalf("Failed to insert test NCR: %v", err)
	}

	req := httptest.NewRequest("POST", "/api/v1/ncrs/NCR-010/create-eco", nil)
	w := httptest.NewRecorder()

	handleCreateECOFromNCR(w, req, "NCR-010")
...
func TestHandleCreateCAPAFromNCR_StatusPropagation(t *testing.T) {
	...
	handleCreateCAPAFromNCR(w, req, "NCR-011")
...
func TestHandleCreateECOFromNCR_StatusPropagation(t *testing.T) {
	...
	handleCreateECOFromNCR(w, req, "NCR-012")
...
func TestHandleCreateCAPAFromNCR_MultipleFromSameNCR(t *testing.T) {
	...
	handleCreateCAPAFromNCR(w1, req1, "NCR-013")
	...
	handleCreateCAPAFromNCR(w2, req2, "NCR-013")
	...
	var count int
	db.QueryRow("SELECT COUNT(*) FROM capas WHERE linked_ncr_id='NCR-013'").Scan(&count)

...
func setupTestingHandlerTestDB(t *testing.T) *sql.DB {
	t.Helper()
...
func TestHandleListTests_Empty(t *testing.T) {
	testDB := setupTestingHandlerTestDB(t)
	defer testDB.Close()
	...
	t.Logf("✓ List tests returns empty array when no tests exist")
}
...
func TestHandleListTests_WithData(t *testing.T) {
	...
	t.Logf("✓ List tests returns all test records in DESC order")
}
...
func TestHandleCreateTest_Success(t *testing.T) {
	...
	t.Logf("✓ Create test successful with ID: %d", test.ID)
}
...
func TestHandleCreateTest_InvalidJSON(t *testing.T) {
	...
	t.Logf("✓ Create test rejects invalid JSON")
}
